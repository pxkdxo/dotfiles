##
## less_termcap.sh : configure escape sequences interpreted by 'less'
##

## Characters that may end an escape sequence
export LESSANSIENDCHARS='m\'

## Characters allowed within an escape sequence
export LESSANSIMIDCHARS='!"##%'"'"'()*+/0123456789:;?B[]bgr'


## Skip this if 'tput' is not available (requires ncurses) 
