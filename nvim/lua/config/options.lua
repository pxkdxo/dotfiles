-- Global options, to be loaded before plugins in init.lua
local opt = vim.opt
...
opt.linebreak = false -- Do not wrap lines at convenient points
...
opt.whichwrap = "<,>,[,],b,s"
opt.wildignore = ".git/*,*/.git/*,.hg/*,*/.hg/*,.svn/*,*/.svn/*"
...
opt.directory = string.format(
  "%s/nvim/swap/,%s/nvim/swap/,%s/,/tmp/",
  os.getenv("XDG_CACHE_HOME"),
  os.getenv("XDG_DATA_HOME"),
  os.getenv("TMPDIR")
)
opt.undodir = string.format(
  "%s/nvim/undo/,%s/nvim/undo/,%s/,/tmp/",
  os.getenv("XDG_CACHE_HOME"),
  os.getenv("XDG_DATA_HOME"),
  os.getenv("TMPDIR")
)
opt.backupdir = string.format(
  "%s/nvim/backup/,%s/nvim/backup/,%s/,/tmp/",
  os.getenv("XDG_CACHE_HOME"),
  os.getenv("XDG_DATA_HOME"),
  os.getenv("TMPDIR")
)
opt.guicursor = table.concat(
  {
    "n-c-v:block-nCursor",
    "r-cr-o:hor25-nCursor",
    "i-ci-ve:ver35-iCursor",
    "a:blinkwait1000-blinkoff300-blinkon500-Cursor/lCursor",
    "sm:block-blinkoff250-blinkon250",
