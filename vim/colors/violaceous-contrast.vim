...
"# Warnings and Errors                        #
"########################################
hi! Error   cterm=NONE ctermbg=9  ctermfg=NONE gui=undercurl guisp=Red
hi! Warning cterm=NONE ctermbg=12 ctermfg=NONE gui=undercurl guisp=Blue
hi! Error term=reverse cterm=NONE ctermbg=4 ctermfg=15 gui=reverse,undercurl guibg=Purple guifg=NONE guisp=Purple
hi! Warning  term=reverse cterm=NONE ctermbg=6 ctermfg=15 gui=reverse,undercurl guibg=Blue guifg=NONE guisp=Blue
