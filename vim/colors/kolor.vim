...
if g:kolor_bold==0
  ...
  if g:kolor_alternative_matchparen==0 && g:kolor_inverted_matchparen==0
    highlight MatchParen      guifg=#2e2c29    guibg=#ff5fd7    gui=standout
  elseif g:kolor_inverted_matchparen==0
    highlight MatchParen      guifg=#2e2c29    guibg=#9e9e9e    gui=standout
  else
    highlight MatchParen      guifg=#ffffff     guibg=#ff0087   gui=standout
  endif
else
  ...
  if g:kolor_alternative_matchparen==0 && g:kolor_inverted_matchparen==0
    highlight MatchParen      guifg=#2e2c29    guibg=#ff5fd7    gui=bold,standout
  elseif g:kolor_inverted_matchparen==0
    highlight MatchParen      guifg=#2e2c29    guibg=#9e9e9e    gui=bold,standout
  else
    highlight MatchParen      guifg=#ffffff     guibg=#ff0087   gui=bold,standout
  endif
endif
if g:kolor_italic==0
...
if &t_Co > 255
  ...
  if g:kolor_bold==0
    ...
    if g:kolor_alternative_matchparen==0 && g:kolor_inverted_matchparen==0
      highlight MatchParen      ctermfg=235     ctermbg=206     cterm=standout
    elseif g:kolor_inverted_matchparen==0
      highlight MatchParen      ctermfg=235     ctermbg=247     cterm=standout
    else
      highlight MatchParen      ctermfg=255     ctermbg=198     cterm=standout
    endif
  else
    ...
    if g:kolor_alternative_matchparen==0 && g:kolor_inverted_matchparen==0
      highlight MatchParen      ctermfg=235     ctermbg=206     cterm=bold,standout
    elseif g:kolor_inverted_matchparen==0
      highlight MatchParen      ctermfg=235     ctermbg=247     cterm=bold,standout
    else
      highlight MatchParen      ctermfg=255     ctermbg=198     cterm=bold,standout
    endif
  endif
  if g:kolor_underlined==0
